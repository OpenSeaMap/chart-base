...
public interface IfMapSpace
{
	...
	/**
	 * "Walks" westerly a certain distance on a latitude and returns the "mileage" in map space pixels. The distance is specified as angular distance, therefore
	 * this method works with all length unit systems (e.g. metric, imperial, ...).
	 * 
	 * @param startX
	 ...
	 * @param zoom
	 * @param angularDist
	 *          angular distance: distance / earth radius (e.g. 6367.5km or 3956.6miles)
