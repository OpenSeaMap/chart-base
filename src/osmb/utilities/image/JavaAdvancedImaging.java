...
/**
 * Centralizes all methods that require the optional Java Advanced Imaging library.
 * 
 */
public class JavaAdvancedImaging
{
	...
	public static BufferedImage colorReduceMedianCut(BufferedImage image, int colorCount)
	{
		...
		{
			/*
			 * For preventing the javax.media.jai.util.ImagingException: All factories fail for the operation "ColorQuantizer" we have to create a "compatible" (e.g.
			 * TYPE_3BYTE_BGR) BufferedImage
			 */
			BufferedImage trueColorImage = new BufferedImage(image.getWidth(), image.getHeight(), BufferedImage.TYPE_3BYTE_BGR);
