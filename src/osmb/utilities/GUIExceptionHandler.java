...
import osmb.program.ProgramInfo;
...
public class GUIExceptionHandler implements Thread.UncaughtExceptionHandler, ExceptionListener
{
	...
	public static void processFatalExceptionSimpleDialog(String dialogMessage, Throwable e)
	{
		...
		String[] options =
		{ OSMBStrs.RStr("Exit"), OSMBStrs.RStr("dlg_download_show_error_report") };
		int a = JOptionPane.showOptionDialog(null, dialogMessage, OSMBStrs.RStr("Error"), 0, JOptionPane.ERROR_MESSAGE, null, options, options[0]);
		if (a == 1)
	...
	public static synchronized void showExceptionDialog(String message, Thread thread, Throwable t, String additionalInfo)
	{
		try
		{
			if (t != null)
			{
				...
				{
					if (ste.getClassName().startsWith(thisClassName) && "showExceptionDialog".equals(ste.getMethodName()))
					{
			...
			if (t instanceof IFExceptionExtendedInfo)
			{
				IFExceptionExtendedInfo ei = (IFExceptionExtendedInfo) t;
				sb.append("\n");
			...
			if (t != null)
			{
				...
				guiText = "An unexpected exception occurred (" + exceptionName + ")<br>" + "<p>Please create a ticket in the bug tracker " + "on <a href=\""
						+ URL_BUGTRACKER + "\">SourceForge.net</a><br>" + "<b>Please include a detailed description of your performed actions <br>"
						+ "before the error occurred.</b></p>Be sure to include the following information:";
			}
			else
			{
				dialogTitle = "System report";
				guiText = "This is a user generated system report.<br>" + "<p>It can be used for providing detailed version information <br>"
						+ "in case a new ticket in the bug tracker is created " + "on <a href=\"" + URL_BUGTRACKER + "\">SourceForge.net</a><br>"
						+ "<b>Please include a detailed description of your problem <br>" + "and what steps are necessary to reproduce the problem.</b>" + "</p>";
			}
