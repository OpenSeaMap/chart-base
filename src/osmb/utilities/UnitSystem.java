...
///The earth is modelled commonly as a sphere flattened 0.336% along its axis. This makes the Equator 0.16% longer than a meridian (a great circle passing through the two poles) https://en.wikipedia.org/wiki/Equator -> Metric: meridian, Imperial: Equator
	Imperial(3963.192d, 5280, 1d, "mi", "ft", "in"); ///W 1 mile = 1760 yards * 3 feet / yard = 5280 feet
